...
public class ContaCorrente {
	...
	public void pagarBoleto(double valorb) {
		/*if(saldo > valor) {
			...
			double cheque = (this.saldo - valor)*0.2;
			this.saldo = this.saldo - (this.saldo - valor) - cheque;
			// implementar o restante de cheque especial 
			
		} else {
			System.out.println("Valor de Saldo + Cheque especial para o pagamento do boleto  insuficientes");
		}*/
	...
	public void usaCheque() {
		if(saldo < 0) {
			System.out.println("O uso do cheque está em R$"+ cheque);
		}
	}
